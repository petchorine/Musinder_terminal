...
class DatabaseManager:
    def __init__(self):
        self.path_to_db = r'/home/petchorine/Desktop/monPyhon/mes_projets_python/musinder/V0/musinder.db'
    ...
    def main_menu(self):
        ...
        while True:
            ...
            if main_menu_choice == "1" or main_menu_choice == "2":
                ...
                print("Tu dois choisir entre 1, 2, 3, 4 ou 5")
                continue     
    ...
    def connexion_menu(self):
        while True:
            ...
            if connexion_choice == "1":                
                ...
                if self.db_manager.execute_query(f'''select 1 from users where username = "{username}";'''):
                    User(username).connect_user_to_db()
                    break
                else:
                    print("Ce nom n'est pas dans ma base.")
                    print()
                    continue
                ...
                if username != "":
                    ...
                    print("Ton pseudo ne peut pas être vide.")
                    print()
                    continue
